...
import com.telmoricardo.cursomc.domain.enuns.TipoCliente;
...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "12345678941", TipoCliente.PESSOFISICA);		
		cli1.getTelefones().addAll(Arrays.asList("32752545", "92584525"));		
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 300", "Jardim Brasil", "38220834", cli1, c1);
